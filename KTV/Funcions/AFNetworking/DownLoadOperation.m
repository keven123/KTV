...
-(void)downloadFileWithFileName:(NSString*)fileName
    ...
    [self downloadWithUrl:[NSURL URLWithString:urlStr] cachePath:cacheBlock progressBlock:progressBlock success:success failure:failure];
...
- (void)sendCmd {
//  NSLog(@"%@",[NSString stringWithFormat:COMMAND,IPAdress]);
//    //第一步，创建url
//    NSURL *url = [NSURL URLWithString:SHUTDOWN];
//    
//    //第二步，创建请求
